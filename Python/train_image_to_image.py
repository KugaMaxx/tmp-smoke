...
from sd_embed.embedding_funcs import get_prompts_tokens_with_weights, group_tokens_and_weights, get_weighted_text_embeddings_sd15
...
def log_validation(vae, text_encoder, tokenizer, unet, args, accelerator, weight_dtype, epoch):
    ...
    for (validation_image, validation_prompt) in zip(args.validation_images, args.validation_prompts):
        ...
        with autocast_ctx:
            validation_result = pipeline(validation_prompt, validation_image, num_inference_steps=20, generator=generator).images[0]
...
def parse_args():
    ...
    parser.add_argument(
        "--train_data_dir",
        type=str,
        default="/root/autodl-tmp/csmv-cube-v4-rag-residual",
        help=(
    ...
    parser.add_argument(
        ...
        type=str,
        default=[
            "55.55,0.02,0.00,6.79,0.91,1.27", 
            "0.64,-36.67,-0.09,2.68,5.34,0.55", 
            "-0.99,-0.15,15.12,-0.14,0.59,19.22"
        ],
        nargs="*",
